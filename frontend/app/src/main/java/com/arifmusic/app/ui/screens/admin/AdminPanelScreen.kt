        ...
        Column(
            ...
            TabRow(
                ...
                Tab(
                    ...
                    text = { Text("Dashboard", color = if (selectedTab == AdminTab.DASHBOARD) Green else Color.White) }
                )
                Tab(
                    selected = selectedTab == AdminTab.USERS,
                    onClick = { selectedTab = AdminTab.USERS },
                    text = { Text("Users", color = if (selectedTab == AdminTab.USERS) Green else Color.White) }
                )
                Tab(
                    selected = selectedTab == AdminTab.MUSIC,
                    onClick = { selectedTab = AdminTab.MUSIC },
                    text = { Text("Music", color = if (selectedTab == AdminTab.MUSIC) Green else Color.White) }
                )
                Tab(
                    selected = selectedTab == AdminTab.VERIFICATION,
                    onClick = { selectedTab = AdminTab.VERIFICATION },
                    text = { Text("Verification", color = if (selectedTab == AdminTab.VERIFICATION) Green else Color.White) }
                )
            }
