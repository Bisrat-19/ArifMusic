...
import com.arifmusic.app.data.local.*
import com.arifmusic.app.data.remote.ApiService
import com.arifmusic.app.data.remote.RetrofitClient
import com.arifmusic.app.data.repository.*
...
object AppModule {
    private const val DB_NAME = "arifmusic_db"
    ...
    fun provideMusicRepository(
        ...
        MusicRepository(musicDao, musicPlayedDao, sessionManager, context)
    ...
    fun provideFollowRepository(
        ...
        FollowRepository(followDao, userDao)
